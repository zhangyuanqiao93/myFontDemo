		...
		function parallax(target,offset){
			...
			target.each(function(){
				...
				$(window).scroll(function() {
					...
					plx.css({
					    //animal
						'-webkit-transform':'translateY('+yPos + 'px)',//google or Safari
						'-moz-transform':'translateY('+yPos + 'px)', //Firefox
						'transform':'translateY('+yPos + 'px)' // IE9
					});
				});
			});
			...
			var $this     = $(this),
				...
				switch(t){
					...
					case 'routexl':
				        ...
				        break;
				    case 'satellite':
				        mapTypeId = google.maps.MapTypeId.SATELLI;
				        break;
				    case 'hybrid':
